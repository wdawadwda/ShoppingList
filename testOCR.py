...
from shoppingList.OCR.tess_OCR import text_from_tesseract_ocr
...
def text_recognize(pic_path="./shoppingList/referecces/photo_2024-06-22_19-04-35.jpg"):
    results = {}
    ...
    for rate in [80, 100, 130]:
        try:
            result = text_from_tesseract_ocr(pic_path, rate=rate)
            results[rate] = result
